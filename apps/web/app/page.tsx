...
export default function Home() {
  ...
  return <main><RevealController/><Script id="organization-schema" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }}/><Nav/>
    <section className="hero">
      ...
      <div className="eyebrow hero-badge"><span/>Technology with purpose</div>
      <h1>
        <span className="line"><span className="line-inner">Ideas engineered</span></span>
        <span className="line"><span className="line-inner">for <em>impact.</em></span></span>
      </h1>
      ...
      <div className="hero-actions">
        <a href="#contact" className="hero-cta">Start a project <Icon name="arrow" size={17}/></a>
        <a href="#services" className="text-link">Explore our expertise <Icon name="arrow" size={19}/></a>
      </div>
      <div className="hero-strip" aria-hidden="true">
        <div className="strip-item"><Icon name="fintech" size={15}/><span>Fintech</span></div>
        <div className="strip-item"><Icon name="ai" size={15}/><span>Artificial intelligence</span></div>
        <div className="strip-item"><Icon name="people" size={15}/><span>People technology</span></div>
      </div>
    ...
    <div className="pin-host">
      <section className="statement section-pad stack-panel">
        <div className="eyebrow"><span/>What we believe</div>
        <div className="statement-body">
          <p className="statement-lead">Technology should do more than work.<br/>It should <em>move you forward.</em></p>
          <p className="statement-sub">We partner with ambitious teams to design, build and ship the fintech, AI and people systems that turn that belief into everyday reality.</p>
          <div className="statement-list">
            <div><b>01</b><span>Fintech</span></div>
            <div><b>02</b><span>Artificial intelligence</span></div>
            <div><b>03</b><span>People technology</span></div>
          </div>
        </div>
      </section>
    </div>
